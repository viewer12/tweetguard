...
<p>
  <a href="https://chromewebstore.google.com/detail/jfjlbcabegghndnlplikppaeimbopfjp?utm_source=item-share-cb"><strong>Chrome Web Store 安装 →</strong></a>
  ·
  <a href="#安装">手动安装</a>
</p>
...
<p>
  <a href="https://chromewebstore.google.com/detail/jfjlbcabegghndnlplikppaeimbopfjp?utm_source=item-share-cb">
    <img alt="在 Chrome Web Store 安装 TweetGuard" src="https://img.shields.io/badge/Chrome%20Web%20Store-安装%20TweetGuard-4285F4?style=for-the-badge&logo=googlechrome&logoColor=white">
  </a>
</p>

推荐从 Chrome Web Store 安装正式版本：无需开发者模式，Chrome 会自动更新扩展，适合绝大多数用户。

### 手动安装（开发者 / 侧载）

如果你想测试最新源码、验证未发布版本或自行修改，也可以通过开发者模式安装。两种方式任选其一：
